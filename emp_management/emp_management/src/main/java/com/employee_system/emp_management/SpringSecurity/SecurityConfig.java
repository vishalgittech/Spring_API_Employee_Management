...
import com.employee_system.emp_management.SpringSecurity.JwtRequestFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.csrf(csrf -> csrf.disable())  // Disable CSRF protection (can be enabled for production)
                .authorizeRequests(authz -> authz
                        ...
                        .requestMatchers("/register").permitAll()  // Allow unauthenticated access to the /register endpoint
